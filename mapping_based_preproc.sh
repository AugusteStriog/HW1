...
genome_file="${refs_dir}/mm9.fa.gz"
genome_index="${refs_dir}/mm9"
gtf_file="${refs_dir}/mm9.gtf.gz"
rna_file="${refs_dir}/mm9_rna.fa.gz"
...
if [ ! -f "${genome_index}.1.ht2" ]; then
    gunzip -c ${genome_file} > ${refs_dir}/mm9.fa
    hisat2-build ${refs_dir}/mm9.fa ${genome_index}
fi
